...
@section('content')
    ...
    <h3>Активних курсів немає!</h3>
    @endif
    @foreach($treatments as $treatment)
    <div class="card mb-3">
        <div class="card-body">
            <p class="card-text"><strong>Пацієнт: </strong>{{ $treatment->patient->getFullName() }}</p>
            <p class="card-text"><strong>Відповідальний лікар: </strong>{{ $treatment->patient->doctor->getFullName() }}</p>
